    ...
    <nav className="absolute top-0 left-0 w-full z-[1000] px-6 py-4 md:px-12 transition-all duration-300">
      <div className="max-w-[1440px] mx-auto flex items-center justify-between">
        ...
        <div className="flex-shrink-0 z-[1001]">
          <a href="/" className="cursor-pointer">
            <img
              src="/images/logo.png"
              alt="Ben 10 Logo"
              className="w-24 md:w-32 drop-shadow-[0_0_15px_rgba(0,255,136,0.3)]"
            />
          </a>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-6 font-['Orbitron']">
          <button className="text-white hover:text-[#00ff88] tracking-widest text-sm transition-all">
            LOGIN
          </button>
          ...
          <>
            ...
            >
              <ul className="flex flex-col items-center gap-8 text-center font-['Orbitron'] uppercase">
                ...
                >
                  <button className="py-4 border border-white/20 rounded-full text-white tracking-widest hover:border-[#00ff88]">
                    LOGIN
                  </button>
                  <button className="py-4 bg-[#00ff88] rounded-full text-black font-black tracking-widest shadow-[0_0_20px_rgba(0,255,136,0.3)]">
                    SIGN UP
                  </button>
                </motion.div>
              </ul>
